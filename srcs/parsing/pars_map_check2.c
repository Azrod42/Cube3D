...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/10 10:34:25 by lfantine          #+#    #+#             */
/*   Updated: 2023/01/30 14:07:18 by lfantine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	error_return_xml(int r)
{
	if (r == 0)
		...
		printf("NO file need to be an xpm file\n");
	else if (r == 2)
		printf("SO file need to be an xpm file\n");
	else if (r == 3)
		printf("WE file need to be an xpm file\n");
	else if (r == 4)
		printf("EA file need to be an xpm file\n");
	return (-1);
}
...
int	verif_xml(char *file)
{
	...
	if (file[len - 1] != 'm')
		r = -1;
	else if (file[len - 2] != 'p')
		r = -1;
	else if (file[len - 3] != 'x')
		r = -1;
	else if (file[len - 4] != '.')
		r = -1;
	if (r == -1)
